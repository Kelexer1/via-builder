...
/**
 * @brief Represents a single course that must be scheduled when building a timetable. Even though this represents a
 * single course, different courses should be used for lectures, tutorials, and practicals to ensure they are all
 * considered when building
 */
class Course {
public:
  Course(const std::string& code, const std::string& campus, const std::string& type);
