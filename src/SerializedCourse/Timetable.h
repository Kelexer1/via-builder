...
public:
  ...
  std::array<int, MAX_COURSES> chosenSections; // The section index of each chosen section per course, relative to an
                                               // ordered vector of given courses
  ...
  std::array<std::array<bool, DAYS_PER_WEEK>, MAX_SEMESTERS>
      hasInPersonClass; // Whether any day of any semester has at least one in person class
